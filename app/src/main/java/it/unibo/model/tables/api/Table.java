package it.unibo.model.tables.api;
...
public interface Table<V, K> {
     ...
     *                   database
     * @return an empty optional if there is no object with the given key in the
     *         database
     */
    Optional<V> findByPrimaryKey(K primaryKey);
